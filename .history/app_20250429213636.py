...
try:
    model.load_state_dict(
        torch.load(
            r"C:\Users\risky\OneDrive\Dokumen\~RPS\Binus\Skripsi\air_handsign_web-main-real\models\siamese_cnn1d_1layer_mediapipe_KataHurufAngka_hardtriplet_margin2_epoch300_try9.pth",
            map_location=device,
            weights_only=True
        )
    )
